 ...
 * genus Cucurbita that has culinary and cultural significance[1][2] but no agreed upon botanical 
 * or scientific meaning.[3] The term pumpkin is sometimes used interchangeably with 
 * "squash" or "winter squash", and is commonly used for cultivars of Cucurbita argyrosperma,
 *  Cucurbita ficifolia, Cucurbita maxima, Cucurbita moschata, and Cucurbita pepo.[1] 
